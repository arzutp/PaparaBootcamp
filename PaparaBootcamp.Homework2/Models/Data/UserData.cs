    ...
    { 
        ...
        public static List<User> Users()
        {
            if(users.Count == 0)
            {
                ...
                users.Add(new User() { Id = 6, Name = "Aslı", Surname = "Sütçüoğlu", Email = "asli@gmail.com", Age = 29 });
                users.Add(new User() { Id = 7, Name = "Volkan", Surname = "Sütçüoğlu", Email = "volkan@gmail.com", Age = 32 });
                users.Add(new User() { Id = 8, Name = "Sacit", Surname = "Kral", Email = "sacit@gmail.com", Age = 29 });
                users.Add(new User() { Id = 9, Name = "Burhan", Surname = "Altıntop", Email = "burhan@gmail.com", Age = 32 });
            }
            return users;
        }
    }
